//Defining class for rectangle that stores data of length and breadth and has two functions .area() & perimeter().
//Write a program that uses this class to create two rectangles (rectangle objects) by user inputed length and breadth.
//Compare the areas and perimeters of the those rectangles.
