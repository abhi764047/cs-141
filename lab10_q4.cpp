//By following  program point.cpp, add a member function which print the class Point so that it prints out coordinates as: (2, 3)
//For a point with coordinates (2, 3). Test it in main().
//Test the class Rectangle in main(), demonstrate that all member functions work as defined. 
...
// class Point represents a 2-D point
class Point
{
public:
