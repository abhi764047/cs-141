...
//The next such number is 1225 which is 352, and the sum of the integersfrom 1 through 49. 
    ...
    for(i=1;i>0;i++)
     {
       ...
       for(j=1;j<=i;j++)
       {
         ...
         if(sq==sum && sq>z)
         {
           ...
           //Assign the number get to the variable used for comparing so that one can get next required number
           z=sq;
